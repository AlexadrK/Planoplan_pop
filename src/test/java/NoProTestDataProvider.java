...
public class NoProTestDataProvider {
    ...
    public void setUp() {
       // System.setProperty("webdriver.chrome.driver", "C:\\Users\\Aleksandr\\IdeaProjects\\Planoplan\\drivers\\chromedriver.exe");
        ...
        driver.get("https://planoplan.com/#login");
    ...
    public static Object[][] paymentData() {
        ...
        return new Object[][] { { "ROBOKASSA - оплата с электронного кошелька QIWI", "40" },
                { "ROBOKASSA - оплата с электронного кошелька «Яндекс.Деньги»", "40" }
        };
    ...
    public void paymentTest(String headingText, String expectedPrice) {
        ...
        Assert.assertEquals(headingText, paymentHeading);
